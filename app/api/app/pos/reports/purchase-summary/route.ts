...
export const GET = withPermission(
  ...
  withApiErrorHandling(async (req: NextRequest) => {
    ...
    const data = await posReportService.getPurchaseSummary({ dateFromParam, dateToParam, branchUuid });
    return successResponse('Purchase summary report retrieved successfully', data);
  })
);
