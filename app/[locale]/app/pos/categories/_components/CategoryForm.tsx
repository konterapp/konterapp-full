...
export default function CategoryForm({ categoryId, mode }: CategoryFormProps) {
  ...
  const fetchCategory = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/app/pos/categories/${categoryId}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = mode === 'edit' && categoryId ? `/api/app/pos/categories/${categoryId}` : '/api/app/pos/categories';
