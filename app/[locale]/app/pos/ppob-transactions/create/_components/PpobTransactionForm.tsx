        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 bg-white ${fieldErrors.transactionTypeUuid ? 'border-red-500' : 'border-gray-200 focus:ring-[#EBC170]'}`}
            >
            ...
            {types.length === 0 && (
              <p className="mt-1 text-xs text-gray-400">Belum ada jenis transaksi -- tambah dulu di menu Jenis Transaksi PPOB.</p>
            )}
            {fieldErrors.transactionTypeUuid && <div className="mt-1 text-sm text-red-600">{fieldErrors.transactionTypeUuid[0]}</div>}
          </div>
