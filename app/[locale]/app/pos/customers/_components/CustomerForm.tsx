...
export default function CustomerForm({ customerId, mode }: CustomerFormProps) {
  ...
  const fetchCustomer = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/app/pos/customers/${customerId}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = isEdit ? `/api/app/pos/customers/${customerId}` : '/api/app/pos/customers';
