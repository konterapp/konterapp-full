...
export default function PayablesPage() {
  ...
  const renderPayableCard = (row: PayableRow) => (
    <div className="space-y-2.5">
      ...
      <p className="truncate text-xs text-gray-500">{row.supplier?.name || '-'}</p>
      ...
      {hasPermission('pos.purchase.create') && (
        <div className="border-t border-gray-100 pt-2.5">
          <button
            ...
            disabled={row.outstanding_amount <= 0}
            className="inline-flex min-h-11 w-full items-center justify-center gap-1.5 rounded-lg bg-[#142D52] px-2 text-xs font-semibold text-white transition-colors hover:bg-[#0f2340] disabled:cursor-not-allowed disabled:bg-gray-300"
          >
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="min-w-0">
        <h1 className="text-lg sm:text-2xl font-bold text-[#142D52]">Hutang</h1>
        <p className="mt-1 text-sm sm:text-base text-gray-600">Daftar pembelian yang belum lunas dan sisa hutangnya ke supplier.</p>
      </div>
      ...
      <DataTable
        ...
        renderMobileCard={renderPayableCard}
      />
