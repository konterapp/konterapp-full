...
export default function PurchaseDetailPage({ params }: { params: Promise<{ uuid: string }> }) {
  ...
  const fetchPurchase = async (uuid: string) => {
    try {
      setIsLoading(true);
      setError('');
      const response = await fetch(`/api/admin/pos/purchases/${uuid}`);
      ...
      <div className="p-6">
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/admin/pos/purchases" className="text-[#EBC170] hover:underline">
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <Link href="/admin/pos/purchases" className="cursor-pointer rounded-lg p-2 transition-colors hover:bg-gray-100">
