...
export default function UnitsPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await fetch(`/api/admin/pos/units/${deleteModal.unit.uuid}`, {
        method: 'DELETE',
      });
      const result = await response.json();
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex items-center gap-2">
          {hasPermission('admin.pos.unit.update') && (
            <Link
              href={`/admin/pos/units/${row.uuid}/edit`}
          ...
          {hasPermission('admin.pos.unit.delete') && (
            <button
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {hasPermission('admin.pos.unit.create') && (
          <Link
            href="/admin/pos/units/create"
