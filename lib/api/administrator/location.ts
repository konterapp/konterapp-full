...
export async function getCountries(): Promise<ApiResponse<CountryOption[]>> {
  return apiRequest<CountryOption[]>('/api/administrator/locations/countries', {
    method: 'GET',
  });
}
...
export async function getProvinces(countryId?: number): Promise<ApiResponse<LocationOption[]>> {
  ...
  return apiRequest<LocationOption[]>(`/api/administrator/locations/provinces${params}`, {
    method: 'GET',
  });
}
...
export async function getCities(provinceId?: number): Promise<ApiResponse<LocationOption[]>> {
  ...
  return apiRequest<LocationOption[]>(`/api/administrator/locations/cities${params}`, {
    method: 'GET',
  });
}
...
export async function getSubdistricts(cityId?: number): Promise<ApiResponse<LocationOption[]>> {
  ...
  return apiRequest<LocationOption[]>(`/api/administrator/locations/subdistricts${params}`, {
    method: 'GET',
  });
}
...
export async function getVillages(subdistrictId?: number): Promise<ApiResponse<LocationOption[]>> {
  ...
  return apiRequest<LocationOption[]>(`/api/administrator/locations/villages${params}`, {
    method: 'GET',
  });
}
...
export async function getWilayah(parentKode?: string): Promise<ApiResponse<WilayahOption[]>> {
  ...
  return apiRequest<WilayahOption[]>(`/api/administrator/locations/wilayah${params}`, {
    method: 'GET',
  });
}

export async function getWilayahDetail(kode: string): Promise<ApiResponse<WilayahHierarchy>> {
  return apiRequest<WilayahHierarchy>(`/api/administrator/locations/wilayah/${kode}`, {
    method: 'GET',
  });
}
