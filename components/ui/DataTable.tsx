...
export default function DataTable<T extends Record<string, any>>({
   ...
   return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
         {/* Search and Filter. `flex-wrap` + lebar minimum kolom cari: di layar
             sempit actionComponent yang panjang (mis. toolbar barcode di halaman
             Produk) turun ke barisnya sendiri, bukan menghimpit kolom cari sampai
             tinggal beberapa piksel. Kalau muat sebaris, tampilannya tidak berubah. */}
